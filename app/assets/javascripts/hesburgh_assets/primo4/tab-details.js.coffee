  ...
  getOtherDetails = (element, tabType) ->
    ...
    if !link.data('loaded')
      success = (data) ->
        ...
        return
      $.get "/primo_library/libweb/tiles/local/details.jsp", {id: recordID, primary: 'ndu_aleph'}, success, "html"
    return

  ready = ->
    EXLTA_addTab "New Details", "ndl-details-tab", location.href, "EXLDetailsTab", "detailsTab", "ndl-details-tab", false, checkTabPresence, ".EXLDetailsTab"
